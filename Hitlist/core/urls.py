...
from .views import Hitlist,HitDetails, HitCreate, HitUpdate, HitTerminate, HitterLoginView, HitterRegister
...
urlpatterns = [
    ...
    path("register/",HitterRegister.as_view(),name = "Register" ),
